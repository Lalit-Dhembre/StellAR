...
IL_0009:
	{
		...
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisMeshOrder_tB779C84E6BFA22CA15B56BEFBC9660B156004C61_mEEF54CA41E38545E629EBB0374D6E430EABEAF1F(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 57));
	}
	try
	{
		{
		...
		try
		{
			...
			Dictionary_2_set_Item_m144D9064CC64271EE5919A593369C2F4A90C5A2F(__this, L_3, ((*(MeshOrder_tB779C84E6BFA22CA15B56BEFBC9660B156004C61*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
